...
@Profile("firstAnalysis")
@Service
public class FirstAnalysisRunner implements CommandLineRunner {

    private final static Logger LOG = LogManager.getLogger(FirstAnalysisRunner.class);
    private final static List<StopWatch> stopWatches = Constants.STOP_WATCHES;
    public FirstAnalysisRunner() {
    ...
    public void run(String... args) throws Exception {
        ...
        ProgramEvaluator.evaluate("output/");
